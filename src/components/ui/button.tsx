  ...
  'relative inline-flex gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border bg-background shadow-sm hover:bg-background/80 hover:text-secondary-foreground',
        'outline-dark':
          'border border-background-gray-hover bg-transparent shadow-sm hover:bg-background-gray-hover',
        secondary: 'bg-accent text-primary shadow-sm',
        long: 'bg-mrgn-success/80 text-primary shadow-sm',
        short: 'bg-mrgn-error/80 text-primary shadow-sm',
